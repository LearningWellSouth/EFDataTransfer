    ...
    */
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 2: Vi vill kunna köra den utan att ocksås behöva kommentera in Schedules i denna fil, kommentera ut SchedulesAndPeriods() i andra filen, och till sist kommentera ut delete/trunc-partierna i denna fil
            transferrer.AddSchedulesToCleaningObjectsWithout(); //Möjligt att denna har sönder schemakopplingen för vissa objekt. Kontrollera!!
